...
import { addComplaint, toggleCreateDrawer } from "../../../store/complaintsSlice";
...
const CreateComplaint = () => {
  ...
  const handleSubmit = (values) => {
    dispatch(
      addComplaint({
        recipientName: values.complainOf,
        recipientAvatar: null,
        recipientRole: "",
        category: values.category,
        complainOf: { name: values.complainOf, avatar: null },
  ...
  return (
    ...
    >
      ...
      {/* Complain of */}
      <Form.Item
        label={<span style={labelStyle}>Complain of</span>}
        name="complainOf"
